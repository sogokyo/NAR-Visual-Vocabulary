function columnChart(data, stylename, media,yMin,yMax, yMin1,yMax1, chartpadding,legAlign,labels,lineSmoothing, numTicksy, yAlign,interval,minAxis, ticks,y1ticks,y2ticks){
   ...
   /*]
    ...
    var bar=plot.append("g")
        .attr("id","bar")
        .attr("transform",function(){
                return "translate("+(margin.left+(barWidth/2))+","+(margin.top)+")"})  
    bar.selectAll("."+media+"bar")
        ...
        .call(function(parent){
            parent.append('rect')
                ...
                .attr("width", plotWidth/barData.length*.86)
    ...
    legend.append("line")
        ...
        .attr("x1",w-legOffset+29-(yOffset*0))
        .attr("x2",w-legOffset+29-(yOffset*0)-yOffset)
        .attr("y1",yOffset-0)
        .attr("y2",yOffset-0)
        .attr("class",media+"lines")
