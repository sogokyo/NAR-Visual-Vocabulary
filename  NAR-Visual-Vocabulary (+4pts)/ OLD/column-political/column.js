function columnChart(data,stylename,media,plotpadding,legAlign,lineSmoothing, logScale, logScaleStart,yHighlight, markers, numTicksy, numTicksx, yAlign){
    ...
    var color = d3.scale.ordinal()
      ...
      .range(["#154577","#58bdbb","#ee5427","#ca6dbf","#65a68c","#65a68c","#F2E24D","#cabd92","#99d2d0","#ac252a","#813887","#f9a71a","#4588FF","#9B3E97","#D7E025","#D1D2D4","#636466"]);
    ...
    .rangeRoundBands([0, plotWidth], .15);
