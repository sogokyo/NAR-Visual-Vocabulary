...
function drawFrame(styles, media,titley,suby) {
    ...
    function frame(p) {
        ...
        if(media=="print") {
            ...
            chart.append("path")
            .attr("class",media+"hat")
            .attr("d","M 0,"+(height-.5)+" L"+(width-0)+","+(height-.5)+"")
        };
        ...
        if(media=="web") {
            header.append("path")
            .attr("class",media+"hat")
            .attr("d","M 0,0 L0,0.7 "+(width-0)+",0.7 "+(width-0)+",0")
            chart.append("path")
            .attr("class",media+"hat")
            .attr("d","M 0,"+(height-.7)+" L"+(width-.5)+","+(height-.7)+"")
        ...
        if(media=="social") {
            footer.append("g")
            .attr("transform", "translate(" + (width - 58-25) + "," + (height-25) + ")") 
            .attr("class", media+"logo")
            .append("path")
