  ...
  /*  plot.append("rect")
    ...
    yLabel
        .attr("transform",function(){
                return "translate("+(margin.left+yLabelOffset-2.5)+","+margin.top+")"
            })

//tried copy pasting this to get black origin line, but no joy
    var originValue = 0;
    ...
    .scale(xScale)
    .ticks(numTicksx)
    .tickSize(plotHeight-3)//–10 added to shorten x-axis grey tickmarks
    .orient("bottom");
    ...
    var xLabels=plot.append("g")
      ...
      .call(xAxis)
      .selectAll("text")
      .attr("dy",-plotHeight-margin.top+14);
// orig:
//       .attr("dy",".9em");
