...
function makeChart(data,stylename,media,plotpadding,legAlign,yAlign,colNames){
    ...
    var plotHeight = h-(margin.top+margin.bottom+10);
    ...
    var xScale = d3.scale.ordinal()
        ...
        .rangeBands([84,plotWidth],0)
    
    var yScale = d3.scale.ordinal()
        .domain(d3.range(numRows))
        .rangeBands([42,plotHeight],0)
    ...
    var keyBoxes = plot.append("g")
        ...
        .attr("transform",function(d,i){
            return "translate("+(xScale.rangeBand()*i)+",4)"
        })
    ...
    //rowLabels
     var rowLabels = plot.append("g").attr("id","rowLabels")
        ...
        .attr("y",function(d,i){
            return yScale(i)+(yScale.rangeBand()/2-4.5)
        })
        .attr("x",80)
