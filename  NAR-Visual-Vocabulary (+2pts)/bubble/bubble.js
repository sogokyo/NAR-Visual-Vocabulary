function bubbleChart(data, stylename, media,yMin,yMax,xMin,xMax,numTicksy, numTicksyx,chartpadding,legAlign,largeCircle,subYoffset,yAxisHighlight,axisLabel,xaxisLabel,yaxisLabel,yAlign){
   ...
   //Select the plot space in the frame from which to take measurements
    ...
    var plotWidth=w-margin.left-margin.right-10;
    ...
    var xScale = d3.scale.linear()
        .domain(xExtent)
        .range([7,(plotWidth-yLabelOffset)-10])
    console.log(xExtent)
    ...
    if (axisLabel) {
        plot.append("text")
                ...
                .attr("y", plotHeight+margin.top-(yOffset/1.5))
                .text(xaxisLabel);
        plot.append("text")
                .attr("class",media+"legend")
                .attr("text-anchor", "start")
                .attr("x", 0)
                .attr("y", margin.top-yOffset/0.9)
                .text(yaxisLabel);
    }
